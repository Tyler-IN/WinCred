...
/// </summary>
/// <remarks>
/// These are the flags that can be set in the <see cref="CREDENTIAL.Flags"/> field.
/// They are constrained by the <c>CRED_FLAGS_VALID_INPUT_FLAGS</c> macro in WinCred.h;
/// they are a subset of <see cref="CredentialFlags"/>.
/// </remarks>
[PublicAPI, Flags]
public enum CredentialInputFlags : uint
{
    None = 0,
    PasswordForCert = 1 << 0,
